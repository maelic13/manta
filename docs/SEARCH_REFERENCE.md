...
| Staged TT/good tactical/killer/history/bad tactical ordering | Production `ordering.Picker` generates exact tacticals first and ranks delayed non-tactical quiets from live worker-local history after MAN-S30; disabling Phase-6.5.1b restores the earlier stable rank snapshot, and MAN-S16 capture history remains archived off. | Stable substrate accepted; live-history staging accepted H1 at `+13.19 +/- 7.28` nElo and is production at `775,451` | Keep the switch-off arm reconstructing `799,610`; new ordering work needs its own registered 1T gate |
