...
`775451`. Step 6.5.10.1 is implemented and frozen as `SCORE-033` above; it
changes only the window a non-root node searches and adds no depth, ordering or
feedback consumer. For the rest of Steps 6.5.10-6.5.12 this remains a
future-candidate contract, not
