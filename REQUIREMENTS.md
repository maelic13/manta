...
it is a candidate contract until its registered gate, not a declaration that
its consumers are production. Where `SCORE-016`, `SCORE-019`, `SCORE-021` and
`SCORE-022` describe the superseded isolated mechanisms, they remain the
contracts of their archived switches only. Any incompatible
